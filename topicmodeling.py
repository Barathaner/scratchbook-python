...
# Laden des spacy Modells für Englisch
...
texts = ["""Eine unvorhergesehene Gesellschaft
I
...
vectorizer = TfidfVectorizer(tokenizer=preprocess, max_df=1, min_df=0.85)
...
# Themen aus jedem Modell anzeigen
models = [('LDA', lda_model), ('NMF', nmf_model), ('LSA', lsa_model)]
